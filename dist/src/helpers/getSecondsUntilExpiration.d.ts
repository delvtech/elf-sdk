 ...
 */
export declare function getSecondsUntilExpiration(poolAddress: string, signerOrProvider: Signer | Provider, timestamp: number): Promise<number>;
/**
 ...
 * @returns the seconds until expiration
 */
export declare function getSecondsUntilExpirationByTokenInfo(poolTokenInfo: PrincipalPoolTokenInfo | YieldPoolTokenInfo, timestamp: number): number;
