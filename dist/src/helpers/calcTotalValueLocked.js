...
var getTokenPrice_1 = require("../prices/getTokenPrice");
 ...
 * @returns TVL
 */
function calcTotalValueLocked(chainName, signerOrProvider) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, getTokenPrice_1.getTokenPrice)(chainName, baseAssetContract, currency, signerOrProvider)];
                                    case 1:
                                        baseAssetPrice = _a.sent();
                                        return [2 /*return*/, calcTotalValueLockedForTerm(tokenInfo, addressesJson.addresses.balancerVaultAddress, underlyingContractsByAddress, assetProxyTokenInfos, tokenList.tokens, tokenInfoByAddress, baseAssetPrice, signerOrProvider)];
                                }
                            });
                        }); }))];
                case 1:
...
exports.calcTotalValueLocked = calcTotalValueLocked;
/**
 ...
 */
function calcTotalValueLockedForTerm(trancheInfo, balancerVaultAddress, underlyingContractsByAddress, assetProxyTokenInfos, tokenInfos, tokenInfoByAddress, baseAssetPrice, signerOrProvider) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    accumulatedInterestBNPromise = getAccumulatedInterestForTranche(poolInfo, assetProxyTokenInfos, tokenInfos, signerOrProvider);
                    baseReservesInPrincipalPoolBNPromise = getBaseAssetReservesInPool(poolInfo, balancerVaultAddress, tokenInfoByAddress, underlyingContractsByAddress, signerOrProvider);
                    baseReservesInYieldPoolBNPromise = getBaseAssetReservesInPool(yieldPoolInfo, balancerVaultAddress, tokenInfoByAddress, underlyingContractsByAddress, signerOrProvider);
...
exports.calcTotalValueLockedForTerm = calcTotalValueLockedForTerm;
/**
 ...
 */
function getAccumulatedInterestForTranche(poolInfo, assetProxyTokenInfos, tokenInfos, signerOrProvider) {
    return __awaiter(this, void 0, void 0, function () {
...
exports.getAccumulatedInterestForTranche = getAccumulatedInterestForTranche;
/**
 ...
 */
function getBaseAssetReservesInPool(poolInfo, balancerVaultAddress, tokenInfoByAddress, underlyingContractsByAddress, signerOrProvider) {
    return __awaiter(this, void 0, void 0, function () {
...
exports.getBaseAssetReservesInPool = getBaseAssetReservesInPool;
