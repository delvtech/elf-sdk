 ...
 */
function getTerms(trancheFactoryAddress, wrappedPositionAddress, signerOrProvider) {
    return __awaiter(this, void 0, void 0, function () {
        var trancheFactoryContract, queryFilter, trancheEvents, trancheAddresses;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    queryFilter = trancheFactoryContract.filters.TrancheCreated(null, wrappedPositionAddress, null);
                    return [4 /*yield*/, trancheFactoryContract.queryFilter(queryFilter)];
                case 1:
                    trancheEvents = _a.sent();
                    trancheAddresses = trancheEvents.map(function (event) { var _a; return (_a = event.args) === null || _a === void 0 ? void 0 : _a.trancheAddress; });
                    return [2 /*return*/, trancheAddresses];
            }
        });
    });
}
