 ...
 */
export declare function getElementDeploymentAddresses(
  url: string
 ...
 */
export declare function getElementTermFactoryAddresses(
 ...
 */
export declare function getElementTermAddresses(
  deploymentAddresses: DeploymentAddresses
): string[];
/**
 ...
 */
export declare function getElementPtPoolAddresses(
  deploymentAddresses: DeploymentAddresses
): string[];
/**
 * Get PtPool addresses associated with each term
 ...
 */
export declare function getElementYtPoolAddresses(
  deploymentAddresses: DeploymentAddresses
): string[];
/**
 ...
 */
export declare function getPoolIdByTermAddress(
  termAddress: string,
  deploymentAddresses: DeploymentAddresses,
  poolType: PoolType
): Promise<string>;
 ...
 */
export declare function getBaseTokenAddress(
  deploymentAddresses: DeploymentAddresses,
  tokenKey: string
): string;
